...
if __name__ == "__main__":
    ...
    inputs = {
        "Profession": "associate ai engineer freelancer",
        "target_audience": "Small and Medium Enterprises (SMEs) and startups ",
        "Role_description": "A associate ai engineers that is good at rag based chat bot and minor project on agentic ai using  crew-ai.Also looking for freelance  job. ",
